...
class Statistics:
    def __init__(self, total_group: int, total_ban, total_kick: int, total_check:int,check_whitelist:int,total_users:int,total_servers: int) -> None:
