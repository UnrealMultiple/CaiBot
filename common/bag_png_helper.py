...
golden_fishing_rod = golden_fishing_rod.resize((50, 50), Image.LANCZOS)
...
advanced_combat_techniques = advanced_combat_techniques.resize((50, 50), Image.LANCZOS)
...
def get_bag_png(name: str, inv: list['()'], buffs: list, enhances: list, life: str, mana: str,
    ...
    img.paste(Satchel, (150- 60 , Satchel.height * 1+40), mask=aSatchel)
    ...
    img.paste(pig, (740 - 65, back2.height * 2), mask=apig)
    for h in range(4):
        for i in range(10):
    ...
    img.paste(safe, (1330 - 60, back2.height * 2 + 5), mask=asafe)
    ...
    img.paste(Forge, (1330 - 60, back2.height * 2 + 25 + 265), mask=aForge)
    ...
    img.paste(Vault, (1330 - 55, back2.height * 2 + 25 + 280 + 265), mask=aVault)
    ...
    img.paste(One, (155 - 60, 120 + 280 + 20), mask=aOne)
    index = 290
    ...
    img.paste(Two, (355 - 60, 120 + 280 + 20), mask=aTwo)
    for h in range(10):
    ...
    img.paste(Three, (555 - 60, 120 + 280 + 20), mask=aThree)
    for h in range(5):
    ...
    img.paste(Minecarts, (755 - 60, 125 + 280 + 15), mask=aMinecarts)
    ...
    img.paste(WoodenArrow, (915 - 65, 120 + 280 + 20), mask=aWoodenArrow)
    ...
    if len(buffs) != 0:
        ...
        img.paste(Red_Drug, (712 - 15, 120 + 600 + 8), mask=aRed_Drug)
        for h in range(6):
            for b in range(8):
                if index >= len(buffs):
                    break
    ...
    img.paste(book, (915 + 50 + 50, 120 + 280 + 20), mask=abook)
    ...
    img.paste(life_item, (915 + 50 + 60, 120 + 280 + 30 + 30 + 15), mask=alife_item)
    draw.text((915 + 50 + 60 + 50, 120 + 280 + 30 + 30 + 30), "生命:" + life, font=font2, fill=(255, 106, 106))

    img.paste(mana_item, (915 + 50 + 60, 120 + 280 + 30 + 30 + 15 + 40), mask=amana_item)
    draw.text((915 + 50 + 60 + 50, 120 + 280 + 30 + 30 + 30 + 40), "魔力:" + mana, font=font2, fill=(30, 144, 255))

    if quests_completed >= 50:
        img.paste(golden_fishing_rod, (915 + 50 + 70, 120 + 280 + 30 + 30 + 30 + 40 + 40), mask=agolden_fishing_rod)
        draw.text((915 + 50 + 60 + 50, 120 + 280 + 30 + 30 + 30 + 40 + 40), f"渔夫任务数:{quests_completed}次",
                  font=font2, fill=(255, 223, 0))
    else:
        img.paste(sitting_duck_fishing_pole, (915 + 50 + 70, 120 + 280 + 30 + 30 + 30 + 40 + 30),
                  mask=asitting_duck_fishing_pole)
        draw.text((915 + 50 + 60 + 50, 120 + 280 + 30 + 30 + 30 + 40 + 40), f"渔夫任务数:{quests_completed}次",
                  font=font2, fill=(0, 0, 205))

    img.paste(advanced_combat_techniques, (915 + 50 + 70, 120 + 280 + 30 + 30 + 30 + 40 + 40 + 30),
